...
La maggior parte dei terremoti si verifica a profondità superficiali (tra 0-70 km) come evidenziato dalla posizione del box e dalla mediana. Questo riflette la natura della tettonica delle placche, dove l’attività sismica è più frequente lungo i margini delle placche. Tuttavia sono presenti anche outliers a grandi profondità. I terremoti tra 200-300 km sono rari ma presenti. 
...
Per concludere l'analisi abbiamo deciso di analizzare l'evoluzione del numero di terremoti avvenuti a livello globale 
nel periodo di riferimento (1970-2025).
...
La serie storica, evidenzia come il numero di terremoti sia contenuto in un intervallo tra 1500-2000 terremoti l'anno.
Tuttavia, nel periodo compreso tra il 2005 e 2010 c'è stato un incremento siginificativo del numero di terremoti, raggiungendo un picco pari a 2500 terremoti nel 2010.
...
Avendo informazioni relative alla latitudine e alla longitudine c'è sembrato interessante anche studiare questo fenomeno in base al continente dove  è avvenuto. L'idea è cercare di capire in quale dei continenti il fenomeno risulta particolarmente concentrato. A tal fine mediante il codice che riportiamo di seguito abbiamo collegato il continente e lo stato alle osservazioni del database a disposizione. 
